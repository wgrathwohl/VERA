"""
Training MNIST classifier for mode counting.
"""
...
class Net(nn.Module):
    ...
    def __init__(self, img_size):
        ...
        self.fc1 = nn.Linear(64 * ((img_size - 4) // 2) ** 2, 128)
...
def main():
    ...
    if args.save_model:
        torch.save(model.state_dict(), os.path.join(args.save_dir, "mnist_cnn_%d.pt" % args.img_size))
